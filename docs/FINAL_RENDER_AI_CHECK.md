...
Run 2026-07-30T00:26:19.987318+00:00 · `https://lamer-konekte.onrender.com`

**Reachable: YES** (first 200 after 1391 ms) · 24 passed · 0 failed · 0 skipped

| Check | Result | Detail |
|---|---|---|
| deployment reachable (after cold start) | PASS | 1391 ms to first 200 |
...
| live Morisyen marine request succeeded | PASS | 10843 ms |
...
| live image request succeeded | PASS | 1421 ms, quality=acceptable |
